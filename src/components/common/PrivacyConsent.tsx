...
const CONSENT_ITEMS: ConsentItem[] = [
  ...
  },
  {
    ...
    label: '개인정보 수집·이용 동의',
    required: true,
    detail: '수집항목: 이름, 이메일, 프로필 사진 (소셜 로그인 연동 시)\n선택 입력: 프로필 설정, 학습 설정, 휴대전화번호(모의고사·구술시험 신청 시)\n생성 정보: 학습 이용 기록, 학습 성취 기록, 서비스 이용 통계\n이용목적: 학습 진도 저장, 맞춤 추천, 서비스 개선\n보유기간: 서비스 이용 기간 동안 보유하며, 탈퇴 요청 시 접수 후 순차 처리',
    link: '/privacy',
  },
